<div class="modal fade" id="pegawai-add">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="frm_frontend" id="add_pegawai">
					<div class="form-group">
						<label>ID Pegawai :</label>
						<input id="id_pegawai" name="id_pegawai" class="form-control" value="<?php echo $IDPegawai; ?>" type="text" readonly />
					</div>
