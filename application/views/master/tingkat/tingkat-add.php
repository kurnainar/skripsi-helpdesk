<div class="modal fade" id="tingkat-add">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="myModalLabel">Tambah Data Tingkat Masalah</h5>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="cursor:pointer;">×</button>
			</div>
			<div class="modal-body">
				<form name="frm_frontend" id="add-tingkat">
					<div class="form-group">
						<label>ID Tingkat Masalah :</label>
						<input id="id_tm" name="id_tm" class="form-control" type="text" value="<?php echo $IDTM; ?>" readonly />
					</div>
